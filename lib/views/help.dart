...
class CallPanel extends StatelessWidget {
  ...
  final List<String> callTargets = ['National Suicide Prevention Lifeline', 'The Samaritans', 'National Teen Dating Violence Hotline', 'Boys Town National Hotline', 
  'Trevor Project Lifeline', 'Child Help USA National Hotline', 'Military One Source', 'Ayuda En Espa\u00F1ol'];
